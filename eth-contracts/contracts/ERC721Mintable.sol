...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        require(newOwner != address(0), "the given address is not valid");
        _owner = newOwner;
        emit ownerShip();
...
contract ERC165 {
    ...
    function _registerInterface(bytes4 interfaceId) internal {
        require(interfaceId != 0xffffffff, "Interface id should not be 0xffffffff");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "The given address is the owner of the tokenID");
        // TODO require the given address to not be the owner of the tokenId
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender),"shall only be called by token owner or be approved");
    ...
    function setApprovalForAll(address to, bool approved) public {
        require(to != msg.sender, "the given address should not be the caller");
    ...
    function transferFrom(address from, address to, uint256 tokenId) public {
        require(_isApprovedOrOwner(msg.sender, tokenId), "the caller should be the owner or be approved");
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId, bytes memory _data) public {
        ...
        require(_checkOnERC721Received(from, to, tokenId, _data), "Is not received yet");
    }
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId),"the given from address should be the owner");
        // TODO: require token is being transfered to valid address
        require(to != address(0),"the address 'to' is invalid");
        // TODO: clear approval
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function tokenURI(uint256 tokenId) external view returns (string memory) {
        require(_exists(tokenId), "tokenURI does not exists");
